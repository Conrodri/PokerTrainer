...
const MATCHES: MatchEntry[] = [
  ...
  { pattern: 'top pair',          id: 'toppair'  },
  { pattern: 'meilleure paire',   id: 'toppair'  },
  { pattern: 'two pair',          id: 'twopair'  },
  { pattern: 'deux paires',       id: 'twopair'  },
  ...
  { pattern: 'premium',           id: 'premium'  },
  { pattern: 'kickers',           id: 'kicker'   },
  { pattern: 'kicker',            id: 'kicker'   },
